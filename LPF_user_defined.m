...
h1=fir1(n,wc,user_rectangle(n));%rectangular window
h2=fir1(n,wc,user_hamming(n));%hamming window
h3=fir1(n,wc,user_hanning(n));%hanning window
h4=fir1(n,wc,user_blackman(n));%Blackman window
h5=fir1(n,wc,user_traingle(n));%Barlett window
