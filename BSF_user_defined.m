...
h1=fir1(n,[wc1,wc2],'stop',user_rectangle(n));%rectangular window
h2=fir1(n,[wc1,wc2],'stop',user_hamming(n));%hamming window
h3=fir1(n,[wc1,wc2],'stop',user_hanning(n));%hanning window
h4=fir1(n,[wc1,wc2],'stop',user_blackman(n));%Blackman window
h5=fir1(n,[wc1,wc2],'stop',user_traingle(n));%Barlett window
